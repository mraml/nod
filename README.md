...
EU AI Act: Articles 6, 10, 11, 12, 14, 15 (High-Risk classifications).

NIST AI RMF: Govern, Map, Measure, Manage functions.

OWASP LLM Top 10: Prompt Injection, Data Leakage, Model Theft.

Security Baseline: Encryption, Access Control, Secrets Management.
